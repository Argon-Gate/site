    ...
    return (
        ...
        >
            <div className="w-full text-center" style={{ maxWidth: 'var(--max-width)' }}>
                ...
                >
                    Outsourcing de desenvolvimento para quem precisa criar novos sistemas, manter os que já existem ou
                    evoluir o que está em produção. APIs, integrações e aplicações completas.
                </p>
