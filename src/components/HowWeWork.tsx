...
const steps: StepData[] = [
    {
        ...
        description: 'Mergulhamos no seu contexto para compreender processos, desafios e objetivos estratégicos.',
    },
    {
        number: '02',
        icon: Target,
        title: 'Alinhamento de Necessidade e Intenção',
        description: 'Entendemos exatamente o que você precisa, por que precisa e qual resultado espera alcançar.',
        highlight: true,
    },
    {
        number: '03',
        ...
        description: 'Traduzimos sua necessidade em requisitos técnicos claros, objetivos e validados.',
    },
    {
        number: '04',
        icon: Monitor,
    ...
    },
    {
        ...
        description: 'Definimos etapas, prazos e marcos de entrega com total transparência.',
    },
    {
        number: '06',
        icon: Code2,
        title: 'Implementação',
        description: 'Desenvolvimento com comunicação contínua, foco em qualidade e entregas consistentes.',
        highlight: true,
    },
    {
        number: '07',
        ...
        description: 'Entregamos toda a documentação técnica necessária para sustentação e futuras evoluções.',
    },
    {
        number: '08',
        icon: Activity,
        title: 'Acompanhamento em Produção',
        description: 'Suporte no go-live, monitoramento inicial e garantia de estabilidade no lançamento.',
    },
    {
        number: '09',
        icon: Package,
...
function StepCard({ step, style }: { step: StepData; style?: CSSProperties }) {
    ...
    return (
        <div className={cardClass} style={style}>
            <div className="flex items-center gap-3 mb-3">
                ...
                <Icon size={18} style={{ color: 'var(--color-text-secondary)' }} strokeWidth={1.5} />
            </div>
            <h3
                style={{
                    fontSize: '1.05rem',
...
function HConnector({ direction = 'right', style }: { direction?: 'right' | 'left'; style?: CSSProperties }) {
    const isRight = direction === 'right';
    return (
        <div className="flex items-center" style={style} aria-hidden="true">
            {!isRight && (
                <ChevronLeft
                    size={18}
...
function VConnector({ style }: { style?: CSSProperties }) {
    return (
        <div className="flex flex-col items-center" style={style} aria-hidden="true">
...
function MobileConnector() {
    return (
        <div className="flex justify-center" style={{ height: '2rem' }} aria-hidden="true">
    ...
    return (
        <section id="processo" ref={sectionRef} className="section-container">
            <ScrollReveal>
                ...
                >
                    Um processo claro, colaborativo e orientado a resultado — do entendimento inicial ao lançamento em
                    produção.
                </p>
            </ScrollReveal>
            ...
            <ScrollReveal>
                <div className="flow-grid">
                    ...
                    <HConnector direction="right" style={{ gridColumn: 2, gridRow: 1 }} />
                    <StepCard step={steps[1]} style={{ gridColumn: 3, gridRow: 1 }} />
                    <HConnector direction="right" style={{ gridColumn: 4, gridRow: 1 }} />
                    ...
                    <HConnector direction="left" style={{ gridColumn: 4, gridRow: 3 }} />
                    <StepCard step={steps[4]} style={{ gridColumn: 3, gridRow: 3 }} />
                    <HConnector direction="left" style={{ gridColumn: 2, gridRow: 3 }} />
                    ...
                    <HConnector direction="right" style={{ gridColumn: 2, gridRow: 5 }} />
                    <StepCard step={steps[7]} style={{ gridColumn: 3, gridRow: 5 }} />
                    <HConnector direction="right" style={{ gridColumn: 4, gridRow: 5 }} />
